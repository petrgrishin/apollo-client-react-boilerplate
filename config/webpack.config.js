...
const imageInlineSizeLimit = Number.parseInt(process.env.IMAGE_INLINE_SIZE_LIMIT || '10000');
...
module.exports = function (webpackEnvironment) {
    ...
    const isEnvironmentProductionProfile = isEnvironmentProduction && process.argv.includes('--profile');
        ...
        const loaders = [
            ...
            },
            {
                ...
                options: {
                    ...
                    sourceMap: isEnvironmentProduction ? shouldUseSourceMap : isEnvironmentDevelopment,
                },
            },
        ].filter(Boolean);
        if (preProcessor) {
    ...
    return {
        ...
        output: {
            ...
            devtoolModuleFilenameTemplate: isEnvironmentProduction
                ...
                : isEnvironmentDevelopment && ((info) => path.resolve(info.absoluteResourcePath).replaceAll('\\', '/')),
        },
        cache: {
            type: 'filesystem',
            ...
            rules: [
                ...
                },
                {
                    ...
                    oneOf: [
                        ...
                        // Merge this config once `image/avif` is in the mime-db
